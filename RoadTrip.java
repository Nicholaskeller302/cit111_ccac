...
public class RoadTrip {
    ...
    public static void main(String[] args){
        ...
        System.out.println("Print doubles: " + distanceToMoabUtah);
        ...
        //"see" hith hiker heading West
        System.out.println("Oh, look! A person who wants to go West, too!");
        
        // Check if there is any room in the car, if so, pick up the hitch hiker
        if(carFull == false){
